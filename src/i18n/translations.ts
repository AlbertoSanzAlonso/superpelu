...
const es = {
  ...
  nav: {
    ...
    bookAppointmentOnline: 'Reservar cita online',
  ...
  servicePicker: {
    public: {
      ...
      colorDuration: '90 min (color + pausa + lavado)',
      minutes: (n: number) => `${n} min`,
    },
  },
  booking: {
    pageTitle: 'Reserva tu cita',
    pageSubtitle: 'Elige servicio, profesional, día y hora. Martes a sábado de 10:00 a 20:00.',
    ...
    chooseStaffFirst: 'Primero elige tu tratamiento',
    loadingStaff: 'Cargando equipo…',
    noStaff: 'No hay profesionales para este servicio.',
    chooseDayFirst: 'Elige un profesional',
    chooseDay: 'Primero elige un día',
...
const en = {
  ...
  servicePicker: {
    public: {
      ...
      colorDuration: '90 min (colour + break + wash)',
      minutes: (n: number) => `${n} min`,
    },
  },
  booking: {
    pageTitle: 'Book your appointment',
    pageSubtitle: 'Choose service, stylist, day and time. Tuesday to Saturday, 10:00–20:00.',
    ...
    chooseStaffFirst: 'Choose your treatment first',
    loadingStaff: 'Loading team…',
    noStaff: 'No stylists available for this service.',
    chooseDayFirst: 'Choose a stylist',
    chooseDay: 'Choose a day first',
