...
const es = {
  ...
  salonCategories: {
    ...
    'haircut-blowdry': 'Corte y peinado',
    haircut: 'Corte',
    blowdry: 'Peinado',
    perm: 'Permanente',
  ...
  booking: {
    ...
    chooseServiceFirst: 'Primero elige al menos un tratamiento',
    addAnotherService: 'Añadir otro tratamiento',
    ...
    returningCustomerQuestion: '¿Has sido cliente de Superpelu?',
    returningCustomerYes: 'Sí, ya soy cliente',
    returningCustomerNo: 'No, es mi primera vez',
  ...
  customerPages: {
    ...
    cancel: {
      ...
      multiIntro: 'Tienes varios tratamientos reservados. Elige cuál quieres cancelar:',
      selectTreatment: 'Cancelar este tratamiento',
      cancelAllSection: 'O cancelar toda la visita',
      cancelAllButton: 'Cancelar todos los tratamientos',
      cancelAllConfirmHeading: '¿Cancelar toda la visita?',
      cancelAllIntro: 'Se cancelarán todos estos tratamientos:',
      cancelAllConfirmButton: 'Sí, cancelar toda la visita',
      confirmButton: 'Sí, cancelar la cita',
      headingTreatment: '¿Cancelar este tratamiento?',
      confirmTreatmentButton: 'Sí, cancelar este tratamiento',
      hint: 'Si fue un error, cierra esta página y tu cita seguirá activa.',
      hintTreatment: 'Si fue un error, cierra esta página y el tratamiento seguirá activo.',
      successTitle: 'Cita cancelada',
      successHeading: '✅ Cita cancelada',
      successBody: 'Tu cita ha sido cancelada correctamente.',
      successAllBody: 'Todos los tratamientos de tu visita han sido cancelados correctamente.',
      successFooter: 'Si quieres, puedes reservar otra cuando quieras. ¡Gracias!',
    },
    manage: {
      title: 'Gestionar cita',
      heading: 'Gestionar tu cita',
      multiIntro: 'Tienes varios tratamientos reservados. Elige cuál quieres modificar:',
      selectTreatment: 'Modificar',
      changeTreatment: 'Elegir otro tratamiento',
      modifySection: 'Modificar cita',
      modifyTreatmentSection: 'Modificar tratamiento',
      ...
      cancelTreatmentButton: 'Cancelar este tratamiento',
      cancelAllButton: 'Cancelar toda la visita',
      salonClosed:
    ...
    updated: {
      ...
      treatmentCancelled: 'Tratamiento cancelado correctamente.',
    },
    visitChanges: {
...
const en = {
  ...
  salonCategories: {
    ...
    bleaching: 'Bleaching',
    'haircut-blowdry': 'Cut and styling',
    haircut: 'Haircut',
    blowdry: 'Styling',
    perm: 'Perm',
  ...
  booking: {
    ...
    chooseServiceFirst: 'Choose at least one treatment first',
    addAnotherService: 'Add another treatment',
    ...
    returningCustomerQuestion: 'Have you been to Superpelu before?',
    returningCustomerYes: 'Yes, I am a returning client',
    returningCustomerNo: 'No, this is my first visit',
  ...
  customerPages: {
    ...
    cancel: {
      ...
      multiIntro: 'You have several treatments booked. Choose which one to cancel:',
      selectTreatment: 'Cancel this treatment',
      cancelAllSection: 'Or cancel the entire visit',
      cancelAllButton: 'Cancel all treatments',
      cancelAllConfirmHeading: 'Cancel the entire visit?',
      cancelAllIntro: 'All of these treatments will be cancelled:',
      cancelAllConfirmButton: 'Yes, cancel entire visit',
      confirmButton: 'Yes, cancel appointment',
      headingTreatment: 'Cancel this treatment?',
      confirmTreatmentButton: 'Yes, cancel this treatment',
      hint: 'If this was a mistake, close this page and your appointment will remain active.',
      hintTreatment: 'If this was a mistake, close this page and the treatment will remain active.',
      ...
      successAllBody: 'All treatments in your visit have been cancelled successfully.',
      successFooter: 'If you like, you can book another whenever you want. Thank you!',
    },
    manage: {
      title: 'Manage appointment',
      heading: 'Manage your appointment',
      multiIntro: 'You have several treatments booked. Choose which one to modify:',
      selectTreatment: 'Modify',
      changeTreatment: 'Choose another treatment',
      modifySection: 'Modify appointment',
      modifyTreatmentSection: 'Modify treatment',
      ...
      cancelTreatmentButton: 'Cancel this treatment',
      cancelAllButton: 'Cancel entire visit',
      salonClosed:
    ...
    updated: {
      ...
      treatmentCancelled: 'Treatment cancelled successfully.',
    },
    visitChanges: {
