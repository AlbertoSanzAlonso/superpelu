...
import { hoursUntilAppointment, isSalonOpenDay, isWithinSalonBookingWindow } from "@/lib/dates"
import {
  getBookingSpanMinutes,
  getOccupiedSegmentsForBooking,
  usesColorSplitBooking,
} from "@/lib/bookingOccupancy"
import { lockStaffDayForBooking, lockStaffDaysForBooking } from "@server/bookingLock.js"
import {
...
import { createChainedBookingAppointment, resolveChainContinuation } from "@server/appointmentChain.js"
import { collectDatesForSeriesScope } from "@server/seriesDates.js"
import { isValidDateString, timeToMinutes } from "@server/appointmentTime.js"
import type { CreateAppointmentInput } from "@server/appointmentTypes.js"
export type { CreateAppointmentInput } from "@server/appointmentTypes.js"
export type { AppointmentSeriesMode } from "@server/appointmentSeries.js"
export { getAppointmentSeriesMeta } from "@server/appointmentSeries.js"
